...
//      Note from Bryan: if I change the second if, I get some errors
...
let petStatus = 'Beyond known physics, are you Schrodinger?'

if ( pets <= this.allowedPets) {
  let petStatus = 'I can have more pets.'
}
else if ( pets  == this.allowedPets) {
...
let luckyResult = 'You must be something of a jinx if you do not have a lucky number.'
var text; 
var pLuck = luckyNumber
//      I could have used 'luckyNumber' itself,
//      however it might be wrong so I will make an Easter Egg
//      They are rolling a d6, correct?
switch (pLuck) {
  case 1:
...
result = (adventurous = true) ? 'How about we stay home.': 'Adventures are great.'
console.log( result );
